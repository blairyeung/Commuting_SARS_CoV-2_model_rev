public class GuassianDist {
    public static void main(String[] args) {
        double[] DistFun = GetGaussianDist(15, 1,20);
    ...
    public static double[] GetGaussianDist(double Peak, double theta,double Range){
        double Precision = 1000;
        double sum = 0;
        double FractionSum = 0;
        int NextInt = 1;
        double Probabilities[] = new double[(int) Range];
        for (double i1 = -0.5; i1 < Range; i1+=Range/Precision) {
